...
/**
 * iOS implementation of ConnectionRepository using SQLDelight.
 */
actual fun createConnectionRepository(database: TinsuMobile): ConnectionRepository {
    return IosConnectionRepository(database)
}

private class IosConnectionRepository(
